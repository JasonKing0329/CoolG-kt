...
import com.king.app.coolg_kt.model.http.progress.ProgressInterceptor
 ...
 * 文件下载
 */
class DownloadClient(progressListener: ProgressListener?) {
    private val baseUrl: String = UrlProvider.formatUrl(UrlProvider.getBaseUrl())
...
//        logging.setLevel(HttpLoggingInterceptor.Level.BODY);
        ...
        client = if (progressListener != null) {
            val progress = ProgressInterceptor(progressListener)

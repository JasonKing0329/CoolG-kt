...
/**
 * Desc: 业务同StarIndexEmitter，只不过将结果存储在MutableList<String>中，不一个个发射
 *
 * @author：Jing Yang
 * @date: 2018/5/21 10:15
 */
class StarIndexProvider {
    ...
    private fun addIndex(e: MutableList<String>, value: String, i: Int) {
    ...
    fun createRecordsIndex(e: MutableList<String>, mList: List<StarWrap>) {
        // list查询出来已经是有序的
    ...
    fun createRatingIndex(e: MutableList<String>, mList: List<StarWrap>, type: Int) {
        // list查询出来已经是有序的
    ...
    fun createNameIndex(e: MutableList<String>, mList: List<StarWrap>) {

...
public class ScreenUtils {
    ...
    public static final int DP_360 = 360;

    public static final int DP_540 = 540;

    public static final int DP_1080 = 1080;
    ...
    public static int dp2px(float dipValue) {
        final float scale = CoolApplication.Companion.getInstance().getResources().getDisplayMetrics().density;
     ...
     * @return DP_XXX
     */
    public static int getResourceDp(Context context) {
